...
export const CartProvider = ({ children }) => {
  ...
  return (
    <CartContext.Provider value={{ ...state, cartCount, cartSubtotal, isWishlisted, addItem, removeItem, updateQty, clearCart, openCart, closeCart, toggleCart, toggleWishlist }}>
      {children}
